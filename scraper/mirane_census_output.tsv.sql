...
INSERT INTO census_classes(name,tier) VALUES('Summoner',2);
...
-- row 9
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('"Don" Bon Hopkins','"Don" Bon Hopkins','https://docs.google.com/spreadsheets/d/1JnCGIzLzcO-iQEmMhHdfxNwKGZWWiHA5pp4g-tAlCsg/edit?usp=sharing',1280,'Chimera','Rabbitfolk','4/3/2025','4/16/2025','4/21/2025') RETURNING id)
...
-- row 11
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Cali Bell (Feyrod)','Calia Bell','https://docs.google.com/spreadsheets/d/1A8Wul_z_SDW3CpBbmSC1cjWYWqWy3SC2/edit?usp=drivesdk&ouid=118431694302210274652&rtpof=true&sd=true',1000,'Chimera','Rabbitfolk','4/10/2025','5/6/2025','5/6/2025') RETURNING id)
INSERT INTO census_character_classes(character_id,class_id) SELECT c.id, cl.id FROM c, census_classes cl WHERE cl.name IN ('Mage','Martial Artist','Rogue');
-- row 12
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Vim N Vigor','Pádraigín','https://docs.google.com/spreadsheets/d/1GqFLGCo-NuRpn5bmwd_AXZ96fcmmes8K/edit?usp=sharing&ouid=109138423568570624496&rtpof=true&sd=true',1300,'Fae','Gnome',NULL,NULL,NULL) RETURNING id)
...
-- row 17
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Florentino','Voltaire Schild','https://docs.google.com/spreadsheets/d/136ADhP8CtKerL8ZrwP_lDUcAxfbQmG6K/edit?gid=1997331408#gid=1997331408',1100,'Human','Divine Protection','4/10/2025','5/6/2025','5/6/2025') RETURNING id)
...
INSERT INTO census_character_classes(character_id,class_id) SELECT c.id, cl.id FROM c, census_classes cl WHERE cl.name IN ('Fighter','Guardian');
-- row 24
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Shinraku','Shinraku','https://docs.google.com/spreadsheets/d/12uEV4okV3oKZGX_fDZ_obfk32z_GxP0v/edit?gid=1997331408#gid=1997331408',1245,'Youkai','Oni','4/2/2025','4/7/2025','4/8/2025') RETURNING id)
...
-- row 28
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Draig','Draig','https://docs.google.com/spreadsheets/d/e/2PACX-1vRVZL1dBAIvyb5IqLj09Cqm3aQcIQsVpwPgEzMAjsqZT2VTjD2ZGBMjUeB5Qx4dIw/pubhtml',1420,'Human-Chimera','Phoenix','4/12/2025','4/19/2025',NULL) RETURNING id)
INSERT INTO census_character_classes(character_id,class_id) SELECT c.id, cl.id FROM c, census_classes cl WHERE cl.name IN ('Rogue','Ninja');
-- row 29
...
-- row 41
WITH c AS (INSERT INTO census_characters(player_name,adventurer_name,adventurer_url,spirit_core_current,race,sub_race,expedition_departure,expedition_return,ip_lockout_end) VALUES('Florentino','Finia Padfoot','https://docs.google.com/spreadsheets/d/1klr4donLb3l9lepUFzkj9AiXweVofANo/edit?gid=1997331408#gid=1997331408',1290,'Chimera','Catfolk','4/17/2025','5/8/2025','5/13/2025') RETURNING id)
INSERT INTO census_character_classes(character_id,class_id) SELECT c.id, cl.id FROM c, census_classes cl WHERE cl.name IN ('Ranger','Acolyte');
-- row 42
...
INSERT INTO census_character_classes(character_id,class_id) SELECT c.id, cl.id FROM c, census_classes cl WHERE cl.name IN ();